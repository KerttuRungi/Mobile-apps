...
namespace MauiPlanets.Services
{
    internal class PlanetsService
    {
        private static List<Planet> planets = new()
        {
            ...
            {
                Name = "Venus",
                Subtitle = "The second planet from sun",
                HeroImage = "venus.png",
                Description = "Venus is the second planet from sun ",
            ...
            {
                Name = "Earth",
                Subtitle = "The planet of humans",
                HeroImage = "earth.png",
                Description = "The planet of life",
            ...
            {
                Name = "Mars",
                Subtitle = "The planet after earth",
                HeroImage = "mars.png",
                Description = "The planet after earth",
              ...
              new()
            {
                ...
                Description = "The biggest planet in our system",
            ...
            {
                Name = "Saturn",
                Subtitle = "Planet with rings",
                HeroImage = "saturn.png",
                Description = "The planet known for its rings",
            ...
            {
                Name = "Uranus",
                Subtitle = "Planet made of ice",
                HeroImage = "uranus.png",
                Description = "The planet made from ice",
            ...
            {
                Name = "Neptune",
                Subtitle = "Planet furthest from the sun",
                HeroImage = "neptune.png",
                Description = "Last planet in our system",
